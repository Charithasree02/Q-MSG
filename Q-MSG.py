...
/* Global Background - Light Ethereal */
.stApp {
...
/* Titles & Headers (Magical Fonts - Dark Gold) */
h1, h2, h3 {
...
/* Glassy Magical Cards - Light */
.quantum-card {
    background: rgba(255, 255, 255, 0.6);
    border: 1px solid rgba(218, 165, 32, 0.3); /* Soft Gold Border */
    border-radius: 20px;
    padding: 30px;
    margin-bottom: 25px;
    backdrop-filter: blur(20px);
    box-shadow: 0 8px 32px 0 rgba(218, 165, 32, 0.1);
    transition: transform 0.4s ease, box-shadow 0.4s ease;
}
.quantum-card:hover {
    transform: translateY(-5px);
    box-shadow: 0 12px 40px 0 rgba(218, 165, 32, 0.2);
    border-color: rgba(218, 165, 32, 0.6);
    background: rgba(255, 255, 255, 0.8);
}

/* Enchanted Buttons (Rose Gold) */
.stButton>button {
    background-image: linear-gradient(to right, #DA4453 0%, #89216B 100%); /* Deep Rose/Purple for contrast */
...
.stButton>button:hover {
    ...
    box-shadow: 0 6px 20px rgba(137, 33, 107, 0.4);
}

/* Inputs (Light Crystal) */
...
/* Sharing Code Special Box */
.sharing-code-display {
    background: radial-gradient(circle at center, rgba(255, 248, 220, 0.8) 0%, rgba(255, 255, 255, 0.2) 70%);
...
.sharing-code-display::before {
    ...
    width: 200%;
    height: 200%;
    background: radial-gradient(circle, rgba(218, 165, 32, 0.1) 1%, transparent 10%);
